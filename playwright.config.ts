...
export default defineConfig({
  ...
  webServer: {
    command:
      "npm run build && wrangler d1 migrations apply handback --local --persist-to .wrangler/e2e --config wrangler.e2e.jsonc && wrangler dev --port 8799 --persist-to .wrangler/e2e --config wrangler.e2e.jsonc",
